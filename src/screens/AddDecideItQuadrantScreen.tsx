...
const AddDecideItQuadrant = ({ navigation }: any) => {
    const [entryText, setEntryText] = useState<string>('');

    const saveDecideNoteEntry = async (text: string) => {
        try {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.quadrantContainer}>
                ...
                <TouchableOpacity style={styles.saveButton} onPress={() => saveDecideNoteEntry(entryText)}>
...
export default AddDecideItQuadrant;
