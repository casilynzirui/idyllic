...
const AddDoItQuadrant = ({ navigation }: any) => {
    const [entryText, setEntryText] = useState<string>('');

    const saveNoteEntry = async (text: string) => {
        try {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.quadrantContainer}>
                ...
                <TouchableOpacity style={styles.saveButton} onPress={() => saveNoteEntry(entryText)}>
...
export default AddDoItQuadrant;
