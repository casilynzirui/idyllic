...
const EditDelegateItQuadrant = ({ navigation }: any) => {
    const route = useRoute();
    const { note, index } = route.params;
    const [editText, setEditText] = useState(note);

    const editDelegateNoteEntry = async () => {
        try {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.quadrantContainer}>
                ...
                <TouchableOpacity style={styles.saveButton} onPress={editDelegateNoteEntry}>
...
export default EditDelegateItQuadrant;
