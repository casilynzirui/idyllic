    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.quadrantContainer}>
                ...
                <TouchableOpacity style={styles.saveButton} onPress={editNoteEntry}>
...
export default EditDoItQuadrant;
