...
const AddDeleteItQuadrant = ({ navigation }: any) => {
    const [entryText, setEntryText] = useState<string>('');

    const saveDeleteNoteEntry = async (text: string) => {
        try {
            ...
            if (existingNoteEntries) {
                try {
                    ...
                    await AsyncStorage.removeItem('deleteit'); // Remove if there's any corrupted data
                    noteEntriesArray = [];
                }
            }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.quadrantContainer}>
                ...
                <TouchableOpacity style={styles.saveButton} onPress={() => saveDeleteNoteEntry(entryText)}>
...
export default AddDeleteItQuadrant;
